...
CREATE TABLE `tbl_corridas` (
  ...
  CONSTRAINT `id_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `tbl_categoria` (`id_categoria`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tbl_corridas` VALUES (1,'corrida','corrida teste 1','img/upload/corridas/aa.png',100,1,0),(2,'corrida2','corrida teste 2','img/upload/corridas/aa.png',150,1,0);
