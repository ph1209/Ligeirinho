...
CREATE TABLE `tbl_corridas` (
  ...
  CONSTRAINT `fk_sub_cat` FOREIGN KEY (`id_categoria`) REFERENCES `tbl_sub_categoria` (`id_sub_categoria`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tbl_corridas` VALUES (1,'corrida','corrida teste 1','img/upload/corridas/aa.png',100,1,0),(2,'corrida2','corrida teste 2','img/upload/corridas/aa.png',150,1,1);
...
-- Dump completed on 2017-05-25 16:48:56
