...
CREATE TABLE `tbl_promocao` (
  ...
  CONSTRAINT `fk_produto` FOREIGN KEY (`id_produto`) REFERENCES `tbl_produtos` (`id_produto`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tbl_promocao` VALUES (1,25,4,1),(2,90,3,1);
