...
CREATE TABLE `tbl_sub_categoria` (
  ...
  CONSTRAINT `fk_categoria` FOREIGN KEY (`id_categoria`) REFERENCES `tbl_categoria` (`id_categoria`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `tbl_sub_categoria` VALUES (1,'Corrida de Rua',1),(2,'Sub Teste',5);
